// Auto-generated. Per-entity form-enhancements config for "Kurseinheiten".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['kursdatum', 'kursbezeichnung', 'trainer', 'dauer_stunden', 'stundensatz', 'honorar', 'abgerechnet', 'bemerkung'],
  defaults: {
    'kursdatum': { kind: 'today', withTime: true },
    'abgerechnet': { kind: 'literal', value: false },
  },
  computed: {
    'stundensatz': { kind: 'applookup', ownKey: 'trainer', lookupKey: 'standard_stundensatz' },
    'honorar': { op: 'mul', left: { kind: 'field', key: 'dauer_stunden' }, right: { kind: 'field', key: 'stundensatz' } },
  },
};
