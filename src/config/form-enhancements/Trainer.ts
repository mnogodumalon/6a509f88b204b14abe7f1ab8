// Auto-generated. Per-entity form-enhancements config for "Trainer".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{ row: ['vorname', 'nachname'] }, 'email', 'standard_stundensatz'],
  defaults: {
    // Reine Stammdaten — keine Automatik nötig.
    // Vorname/Nachname required, User trägt manuell ein.
  },
  computed: {
    // Keine berechenbaren Felder.
  },
};
